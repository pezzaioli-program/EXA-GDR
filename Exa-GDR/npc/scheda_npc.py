...
class SchedaNPC(QDialog):
    """
    Finestra per visualizzare e modificare una scheda NPC o Nemico.
    Supporta sia visualizzazione che modifica completa.
    """
    ...
    def __init__(self, dati: dict, parent=None):
        ...
        titolo_key = "scheda_nemico" if is_nemico else "scheda_npc"
        self.setWindowTitle(t(titolo_key))
    ...
    def _costruisci_ui(self, is_nemico: bool):
        ...
        # ── Identità ──────────────────────────────────────────────────────────
        grp_id = QGroupBox(t("npc_titolo") if not is_nemico else t("nemico_titolo"))
